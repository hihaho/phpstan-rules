...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $this->replace($this->columns['external_learner_id']);
    }
    ...
    private function replace(Closure &$definition): void
    {
        $definition = fn (Blueprint $table) => $table->string('external_learner_id', 255);
    }
};
