...
final class ScopeRequestValidateMethodTest extends RuleTestCase
{
    ...
    {
        /** @var Error[] $errors */
        $errors = $this->gatherAnalyserErrors([__DIR__ . '/stubs/RequestValidateMethodsInNamespaceStub.php']);
       ...
       $this->analyse([__DIR__ . '/stubs/RequestValidateMethodsInNamespaceStub.php'], [
           [
        ...
        /** @var Error[] $errors */
        $errors = $this->gatherAnalyserErrors([__DIR__ . '/stubs/UserRequest.php']);
        self::assertCount(0, $errors);
        $this->analyse([__DIR__ . '/stubs/UserRequest.php'], []);
    }
}
